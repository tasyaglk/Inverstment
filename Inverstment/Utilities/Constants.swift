...
//  Inverstment
//
//  Created by Тася Галкина on 07.04.2025.
//
...
enum Constants {
    ...
    static let cellBackgroundOffset: CGFloat = 4
    static let cellTrailingOffset: CGFloat = 12
    static let cellBottomOffset: CGFloat = 2
    static let cellTopOffset: CGFloat = 14
    static let cellLeadingOffset: CGFloat = 6
